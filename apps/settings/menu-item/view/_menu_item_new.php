<div class="card">
    ...
    <div class="card-body">
        <form id="menu-item-form" method="post" action="#">
            <div class="row mb-6">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="menu_item_name">
            ...
            <div class="row mb-6">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="app_module_id">
            ...
            <div class="row mb-6">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="parent_id">
                    Parent Menu
                </label>
            ...
            <div class="row mb-6">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="menu_item_icon">
                    Icon
                </label>
            ...
            <div class="row mb-6">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="table_name">
                Export Table
                </label>
            ...
            <div class="row mb-0">
                <label class="col-lg-4 col-form-label fw-semibold fs-6" for="menu_item_url">
                    URL
                </label>
