            ...
            foreach ($options as $row) {
                ...
                $response[] = [
                    'CHECK_BOX' => '<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input datatable-checkbox-children" type="checkbox" value="'. $emailSettingID .'">
                                    </div>',
                    'EMAIL_SETTING_NAME' => '<div class="d-flex align-items-center">
                                    <div>
                                        <div class="user-meta-info">
                                            <h6 class="mb-0">'. $emailSettingName .'</h6>
                                            <small class="text-wrap fs-7 text-gray-500">'. $emailSettingDescription .'</small>
                                        </div>
                                    </div>
                                </div>',
                    'LINK' => $pageLink .'&id='. $emailSettingIDEncrypted
                ];
            }
