(function($) {
    ...
    $(function() {
        ...
        $(document).on('click','#export-data',function() {
            generateExportColumns('contact_information_type');
        });

        $(document).on('click','#submit-export',function() {
            exportData('contact_information_type');
        });
...
function contactInformationTypeTable(datatable_name) {
    toggleHideActionDropdown();
    ...
    const settings = {
        ajax: { 
            url: 'apps/settings/contact-information-type/view/_contact_information_type_generation.php',
            method: 'POST',
            dataType: 'json',
            data: {
                type: type,
