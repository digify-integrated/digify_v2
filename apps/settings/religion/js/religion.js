    ...
    $(function() {
        ...
        $(document).on('click','#delete-religion',function() {
            ...
            if(religion_id.length > 0){
                ...
                showNotification('Deletion Multiple Religion Error', 'Please select the religion you wish to delete.', 'danger');
            }
        });

        $(document).on('click','#export-data',function() {
            generateExportColumns('religion');
        });
...
function religionTable(datatable_name) {
    toggleHideActionDropdown();
