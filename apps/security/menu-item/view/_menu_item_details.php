<div class="card">
    <div class="card-header border-0">
        ...
        <?php
            echo ($deleteAccess['total'] > 0) ? '<button id="delete-menu-item" class="btn btn-sm btn-danger align-self-center">Delete Menu Item</a>' : '';
        ?>
    </div>
    <div class="card-body">
        <form id="menu-item-form" method="post" action="#">
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <label class="fs-6 fw-semibold form-label" for="menu_item_name"><span class="required">Display Name</span></label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <label class="fs-6 fw-semibold form-label" for="app_module_id"><span class="required">App Module</span></label>
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label class="fs-6 fw-semibold form-label" for="parent_id">Parent Menu</label>
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="fs-6 fw-semibold form-label" for="menu_item_icon">Icon</label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <label class="fs-6 fw-semibold form-label" for="table_name">Export Table</label>
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="fs-6 fw-semibold form-label" for="menu_item_url">URL</label>
    ...
    <?php
        echo ($writeAccess['total'] > 0) ? ' <div class="card-footer d-flex justify-content-end py-6 px-9">
                                                ...
                                                <button type="submit" form="menu-item-form" class="btn btn-primary" id="submit-data">Save</button>
                                            </div>' : '';
    ?>
</div>
