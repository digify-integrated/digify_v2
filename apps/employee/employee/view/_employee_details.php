<div class="card mb-10">
    <div class="card-header border-0">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Employee Details</h3>
        </div>
        <?php
    ...
    <div class="card-body">
        <form id="employee-form" class="form" method="post" action="#">
    ...
    <?php
        echo ($writeAccess['total'] > 0) ? '<div class="card-footer d-flex justify-content-end py-6 px-9">
                                                ...
                                                <button type="submit" form="employee-form" class="btn btn-primary" id="submit-data">Save Changes</button>
                                            </div>' : '';
    ?>
</div>
