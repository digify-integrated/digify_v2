<div class="card">
    <div class="card-header d-flex align-items-center">
        <h5 class="card-title mb-0">Subscription Tier Details</h5>
        ...
        <form id="subscription-tier-form" method="post" action="#">
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="text" class="form-control form-control-solid maxlength" id="subscription_tier_name" name="subscription_tier_name" maxlength="100" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-12">
                            <textarea class="form-control form-control-solid maxlength" id="subscription_tier_description" name="subscription_tier_description" maxlength="500" rows="3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
